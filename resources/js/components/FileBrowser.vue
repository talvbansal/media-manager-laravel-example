    ...
    <div class="form-group">
      <div class="input-group mb-3">
        ...
        <div class="input-group-append">
          <button type="button" class="btn btn-outline-secondary" @click="showMediaManager = true">Select Image</button>
        </div>
      </div>
      <div>
        <img v-if="pageImage" class="img img-responsive" id="page-image-preview"
             style="margin-top: 3px; max-height:250px;" :src="pageImage"/>
